        ...
        if latest_checkpoint is not None and isinstance(
            ...
            if metrics.get("research_runtime_version"):
                v3_research_runtime = {
                    ...
                    "information_coverage": checkpoint_state.get(
                        "information_coverage_report"
                    ),
                    "information_recovery_round": checkpoint_state.get(
                        "information_recovery_round", 0
                    ),
                    "information_recovery_exhausted": checkpoint_state.get(
                        "information_recovery_exhausted", False
                    ),
                    "information_recovery_task_count": len(
                        checkpoint_state.get("information_recovery_tasks") or []
                    ),
                }
