...
export const CAMPAIGN_PRESETS: CampaignPreset[] = [
  {
    ...
    values: {
      ...
      scope_limit: 'O conteúdo termina após a transferência da semente recém-germinada para o substrato inicial e a explicação dos primeiros cuidados imediatamente posteriores. O desenvolvimento vegetativo e as fases seguintes poderão ser tratados em conteúdos próprios.',
