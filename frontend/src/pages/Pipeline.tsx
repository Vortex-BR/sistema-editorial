      ...
      {data.v3_research_runtime && (
        <section className="panel execution-manifest">
          <div className="panel-head">
            ...
            <Status
              value={
                data.v3_research_runtime.source_coverage?.synthesis_ready
                  ? "passed"
                  : data.v3_research_runtime.source_coverage?.status ||
                    data.v3_research_runtime.stage ||
                    "running"
              }
            />
          </div>
          <div className="manifest-summary">
            ...
            <div>
              ...
              <small>
                {data.v3_research_runtime.source_coverage?.synthesis_ready
                  ? "A diversidade restante será validada e recuperada por informação específica."
                  : (data.v3_research_runtime.source_coverage?.reason_codes || []).join(" · ") ||
                    "sem bloqueios de cobertura"}
              </small>
            </div>
          </div>
          {informationCoverage && (
